...
import { RefreshCw, TrendingUp, Heart, MessageCircle, Share2, Eye, BarChart3, ExternalLink, Instagram, Facebook, Youtube, Twitter, Linkedin, MessageSquare, Image as ImageIcon } from "lucide-react";
...
export default function Tokeniza() {
  ...
  return (
    <DashboardLayout>
      ...
      {/* AI Chat Assistant */}
      {companyId && <CompanyChat companyId={companyId} companyName={companyName || "Tokeniza"} />}
    </DashboardLayout>
  );
}
